...
class ConsumerLayer(ProtocolLayer):
    def __init__(self, app, above_layer):
        super().__init__(app, above_layer, "CONSUMER")
        assert "notify_provider_cb" in dir(app)
        assert "notify_ping_cb" in dir(app)
    ...
    def notify_provider_cb(self, consumer_nexus, msg):
        self.app.notify_provider_cb(consumer_nexus, msg)

    def notify_ping_cb(self, consumer_nexus, msecs):
        self.app.notify_ping_cb(consumer_nexus, msecs)
